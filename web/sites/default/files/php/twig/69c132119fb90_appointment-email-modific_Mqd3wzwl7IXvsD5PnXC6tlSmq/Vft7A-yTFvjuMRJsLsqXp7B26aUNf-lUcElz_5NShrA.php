...
/* modules/custom/appointment/templates/email/appointment-email-modification.html.twig */
class __TwigTemplate_c121edf86acf19bcbf5b4174eee2d5ce extends Template
{
  ...
  <div style=\"background: #ffc107; color: #333; padding: 20px; border-radius: 6px 6px 0 0; text-align: center;\">
    <h1 style=\"margin: 0; font-size: 22px;\">&#9998; ";
        // line 12
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(t("Rendez-vous modifié"));
        yield "</h1>
  </div>
  ...
  <div style=\"border: 1px solid #ddd; border-top: none; padding: 20px; border-radius: 0 0 6px 6px;\">
    ...
    <p>";
        // line 18
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(t("Votre rendez-vous a été modifié. Voici les nouveaux détails :"));
        yield "</p>
    ...
    <table style=\"width: 100%; border-collapse: collapse; margin: 15px 0;\">
      ...
      <tr>
        <td style=\"padding: 8px; border-bottom: 1px solid #eee; color: #666;\">";
        // line 34
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(t("Type de rendez-vous"));
        yield "</td>
        <td style=\"padding: 8px; border-bottom: 1px solid #eee;\">";
        // line 35
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["appointment"] ?? null), "appointment_type", [], "any", false, false, true, 35), "entity", [], "any", false, false, true, 35), "label", [], "any", false, false, true, 35), "html", null, true);
        yield "</td>
      </tr>
      <tr>
        <td style=\"padding: 8px; border-bottom: 1px solid #eee; color: #666;\">";
        // line 38
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(t("Nouvelle date et heure"));
        yield "</td>
        <td style=\"padding: 8px; border-bottom: 1px solid #eee;\"><strong>";
        // line 39
    ...
    ";
        // line 43
        if ((($tmp = ($context["manage_url"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 44
            yield "    <p style=\"text-align: center; margin: 25px 0;\">
      <a href=\"";
            // line 45
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ($context["manage_url"] ?? null), "html", null, true);
            yield "\" style=\"background: #ffc107; color: #333; padding: 12px 30px; text-decoration: none; border-radius: 4px; display: inline-block; font-weight: bold;\">
        ";
            // line 46
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(t("Voir mon rendez-vous"));
            yield "
      </a>
    </p>
    ";
...
";
    ...
    {
        return "modules/custom/appointment/templates/email/appointment-email-modification.html.twig";
    }
    ...
    {
        return array (  140 => 52,  136 => 50,  129 => 46,  125 => 45,  122 => 44,  120 => 43,  113 => 39,  109 => 38,  103 => 35,  99 => 34,  93 => 31,  89 => 30,  83 => 27,  79 => 26,  73 => 23,  69 => 22,  62 => 18,  55 => 16,  48 => 12,  44 => 10,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "modules/custom/appointment/templates/email/appointment-email-modification.html.twig", "/Users/void/schedulehub_project/web/modules/custom/appointment/templates/email/appointment-email-modification.html.twig");
    }
